...
import com.yuxiao.aigou.goods.service.SpecService;
...
public class SpecController {
    ...
    public Result<List<Spec>> findByCategotyId(@PathVariable("id") Integer categoryId){
        List<Spec> specList = specService.findByCategoryId(categoryId);
        return new Result<List<Spec>>(true,StatusCode.OK,"根据categoryid查询规格参数集合成功",specList);
    }
